  ...
  (function (q, S) {
    ...
    function p(n) {
      for (var e = 1; e < arguments.length; e++) {
        ...
        e % 2 ? S(Object(t), !0).forEach(function (i) {
          q(n, i, t[i])
        }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(n, Object.getOwnPropertyDescriptors(t)) : S(Object(t)).forEach(function (i) {
    ...
    const Z = (n, e, t) => {
      if (console.warn(`Alpine Error: "${t}"

Expression: "${e}"
Element:`, n), !D()) throw Object.assign(t, {
        el: n,
        expression: e
      }), t
    };
    ...
    function m(n, e, t) {
      ...
      if (r) {
        ...
        i = i.concat(Object.entries(s).map(([o, a]) => V({
          name: o,
          value: a
        })))
      }
    ...
    function Ce(n, e, t, i) {
      const r = {
        duration: g(e, "duration", 150),
        origin: g(e, "origin", "center"),
        first: {
          opacity: 0,
          scale: g(e, "scale", 95)
        },
    ...
    function De(n, e, t, i, r) {
      const o = {
        duration: t ? g(e, "duration", 150) : g(e, "duration", 150) / 2,
        origin: g(e, "origin", "center"),
        first: {
          opacity: 1,
          scale: 100
    ...
    function ne(n, e, t, i, r, s, o) {
      ...
      re(n, {
        ...
        during() {
          f && (n.style.transformOrigin = s.origin), n.style.transitionProperty = [d ? "opacity" : "", f ? "transform" : ""].join(" ").trim(), n.style.transitionDuration = `${s.duration / 1e3}s`, n.style.transitionTimingFunction = "cubic-bezier(0.4, 0.0, 0.2, 1)"
        },
        show() {
          t()
        },
    ...
    function ke(n, e, t, i, r) {
      const s = h(_((t.find(c => c.value === "enter") || {
        expression: ""
      }).expression, n, e)),
        o = h(_((t.find(c => c.value === "enter-start") || {
          expression: ""
        }).expression, n, e)),
        a = h(_((t.find(c => c.value === "enter-end") || {
          expression: ""
        }).expression, n, e));
      ie(n, s, o, a, i, () => { }, j, r)
    }
    ...
    function je(n, e, t, i, r) {
      const s = h(_((t.find(c => c.value === "leave") || {
        expression: ""
      }).expression, n, e)),
        o = h(_((t.find(c => c.value === "leave-start") || {
          expression: ""
        }).expression, n, e)),
        a = h(_((t.find(c => c.value === "leave-end") || {
          expression: ""
        }).expression, n, e));
      ie(n, s, o, a, () => { }, i, I, r)
    }
    ...
    function re(n, e, t, i) {
      ...
      n.__x_transition = {
        ...
        finish: r,
        nextFrame: null
      }, e.start(), e.during(), n.__x_transition.nextFrame = requestAnimationFrame(() => {
        let s = Number(getComputedStyle(n).transitionDuration.replace(/,.*/, "").replace("s", "")) * 1e3;
        s === 0 && (s = Number(getComputedStyle(n).animationDuration.replace("s", "")) * 1e3), e.show(), n.__x_transition.nextFrame = requestAnimationFrame(() => {
    ...
    function Ie(n, e, t, i, r) {
      ...
      o.forEach((c, u) => {
        ...
        f ? (delete f.__x_for_key, f.__x_for = l, n.updateElements(f, () => f.__x_for)) : (f = ze(e, a), R(f, () => { }, () => { }, n, i), f.__x_for = l, n.initializeElements(f, () => f.__x_for)), a = f, a.__x_for_key = d
      }), Fe(a, n)
    }
    ...
    function Fe(n, e) {
      for (var t = n.nextElementSibling && n.nextElementSibling.__x_for_key !== void 0 ? n.nextElementSibling : !1; t;) {
        ...
        L(t, () => {
          i.remove()
        }, () => { }, e), t = r && r.__x_for_key !== void 0 ? r : !1
      }
    }
    ...
    function oe(n, e, t, i, r, s, o) {
      ...
      if (t === "value") {
        ...
        } else if (typeof a == "object") Object.keys(a).sort((u, l) => a[u] - a[l]).forEach(u => {
    ...
    function qe(n, e, t, i, r = !1) {
      ...
      const a = (c, u) => {
        t ? ((e.style.display === "none" || e.__x_transition) && R(e, () => {
          o()
        }, u, n), c(() => { })) : e.style.display !== "none" ? L(e, () => {
          c(() => {
            s()
          })
        }, u, n) : c(() => { })
    ...
    function He(n, e, t, i, r) {
      ...
      if (t && (!s || e.__x_transition)) {
        ...
        e.parentElement.insertBefore(o, e.nextElementSibling), R(e.nextElementSibling, () => { }, () => { }, n, i), n.initializeElements(e.nextElementSibling, r), e.nextElementSibling.__x_inserted_me = !0
      } else !t && s && L(e.nextElementSibling, () => {
    ...
    function ue(n, e, t, i, r, s = {}) {
      ...
      let a, c;
      if (i.includes("away") ? (c = document, a = u => {
        e.contains(u.target) || e.offsetWidth < 1 && e.offsetHeight < 1 || (le(n, r, u, s), i.includes("once") && document.removeEventListener(t, a, o))
      }) : (c = i.includes("window") ? window : i.includes("document") ? document : e, a = u => {
        if ((c === window || c === document) && !document.body.contains(e)) {
          c.removeEventListener(t, a, o);
          return
        }
        We(t) && Ge(u, i) || (i.includes("prevent") && u.preventDefault(), i.includes("stop") && u.stopPropagation(), (!i.includes("self") || u.target === e) && le(n, r, u, s).then(d => {
    ...
    function le(n, e, t, i) {
      return n.evaluateCommandExpression(t.target, e, () => p(p({}, i()), {}, {
        $event: t
      }))
    }
    ...
    function Xe(n, e, t, i, r) {
      ...
      ue(n, e, s, t, o, () => p(p({}, r()), {}, {
        rightSideOfExpression: Ye(e, t, i)
      }))
    }

    function Ye(n, e, t) {
      return n.type === "radio" && (n.hasAttribute("name") || n.setAttribute("name", t)), (i, r) => {
        ...
        if (n.type === "checkbox")
          ...
          if (n.tagName.toLowerCase() === "select" && n.multiple) return e.includes("number") ? Array.from(i.target.selectedOptions).map(s => {
    ...
    function $(n, e, t) {
      ...
      return A.call(e, "value") ? e.value = t(n, e.value) : (v(r) || (e.get = function () {
        return t(n, r.call(x(this)))
      }), v(i) || (e.set = function (s) {
    ...
    class O {
      constructor(e, t = null) {
        ...
        this.$data = u, this.membrane = c, this.unobservedData.$el = this.$el, this.unobservedData.$refs = this.getRefsProxy(), this.nextTickStack = [], this.unobservedData.$nextTick = d => {
          this.nextTickStack.push(d)
        }, this.watchers = {}, this.unobservedData.$watch = (d, f) => {
        ...
        }), this.showDirectiveStack = [], this.showDirectiveLastElement, t || y.onBeforeComponentInitializeds.forEach(d => d(this));
        var l;
        s && !t && (this.pauseReactivity = !0, l = this.evaluateReturnExpression(this.$el, s), this.pauseReactivity = !1), this.initializeElements(this.$el, () => { }, t), this.listenForNewElementsToInitialize(), typeof l == "function" && l.call(this.$data), t || setTimeout(() => {
      ...
      wrapDataInObservable(e) {
        ...
        return it(e, (r, s) => {
          t.watchers[s] ? t.watchers[s].forEach(o => o(r[s])) : Array.isArray(r) ? Object.keys(t.watchers).forEach(o => {
            let a = o.split(".");
            s !== "length" && a.reduce((c, u) => (Object.is(r, c[u]) && t.watchers[o].forEach(l => l(r)), c[u]), t.unobservedData)
          }) : Object.keys(t.watchers).filter(o => o.includes(".")).forEach(o => {
            let a = o.split(".");
      ...
      initializeElements(e, t = () => { }, i = !1) {
        this.walkAndSkipNestedComponents(e, r => {
      ...
      updateElements(e, t = () => { }) {
        this.walkAndSkipNestedComponents(e, i => {
        ...
        new MutationObserver(r => {
          for (let s = 0; s < r.length; s++) {
            ...
            if (o && o.isSameNode(this.$el)) {
              ...
              r[s].addedNodes.length > 0 && r[s].addedNodes.forEach(a => {
      ...
      getRefsProxy() {
        ...
        return new Proxy(t, {
          get(i, r) {
            ...
            var s;
            return e.walkAndSkipNestedComponents(e.$el, o => {
    ...
    const y = {
      ...
      start: async function () {
        D() || await Ee(), this.discoverComponents(e => {
      ...
      discoverUninitializedComponents: function (e, t = null) {
        ...
        Array.from(i).filter(r => r.__x === void 0).forEach(r => {
          e(r)
        })
      },
      listenForNewUninitializedComponentsAtRunTime: function () {
        ...
        new MutationObserver(r => {
          if (!this.pauseMutationObserver)
            for (let s = 0; s < r.length; s++) r[s].addedNodes.length > 0 && r[s].addedNodes.forEach(o => {
              o.nodeType === 1 && (o.parentElement && o.parentElement.closest("[x-data]") || this.discoverUninitializedComponents(a => {
    ...
    return D() || (window.Alpine = y, window.deferLoadingAlpine ? window.deferLoadingAlpine(function () {
      window.Alpine.start()
    }) : window.Alpine.start()), y
  })
})(at);